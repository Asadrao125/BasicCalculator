        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!msg.equals(""))
                {
                    ...
                    Toast.makeText(MessageActivity.this, "Succes", Toast.LENGTH_SHORT).show();
                }
                else
                {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             //   mchat.clear();
                for (DataSnapshot snapshot : dataSnapshot.getChildren())
                {
                 ...
                 System.out.println(" reciver ki id "+chat.getReceiver());
                    System.out.println(" sender k id ki id "+chat.getSender());
                   if (chat.getReceiver().equals(userid) && chat.getSender().equals(myid)) {
                        mchat.add(chat);
                    }
               System.out.println("abc"+chat.getReceiver()  +"  "+  chat.getMessage()   +"  "+  chat.getSender());
                }
